  ...
  return (
    <div className="h-full flex overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative min-h-0">
        ...
        <div className="flex-1 p-8 relative flex flex-col items-center justify-center overflow-y-auto overflow-x-hidden">
          ...
          {results.length === 0 ? (
            <div className="relative flex flex-col items-center justify-center text-center space-y-5 max-w-md">
              ...
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center glow-primary-lg animate-aura">
                <FiVideo className="text-2xl text-bg-page" />
              </div>
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-gradient-soft">
        ...
        {/* ── Composer ─────────────────────────────────────────────────────── */}
        <div className="px-4 pb-5 flex-shrink-0 flex flex-col items-center">
          {/* Mode tabs */}
          <div className="mb-3 inline-flex items-center gap-1 p-1 rounded-full glass-panel border border-glass-border">
            {MODES.map((m) => {
